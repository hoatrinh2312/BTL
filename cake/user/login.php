                    ...
                    <div class="login_style"> 
                        <form method="post" action="logged.php" autocomplete="on">
                            <table width="535" height="200" cellpadding="10">
                                <tr>
                                    <td> 
                                        <input style="width: 93%" type="text" name="taikhoan" placeholder="Nhập tên đăng nhập" size="40" required> 
                                    </td>
                                </tr>
                                <tr>
                                    <td> 
                                        <input style="width: 93%" type="password" name="matkhau" placeholder="Nhập mật khẩu" size="40" required> 
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="width: 93%">
                                        <input style="width: 93%" type="submit" name="dangnhap" value="Đăng nhập">
